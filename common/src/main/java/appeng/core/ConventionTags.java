 ...
 * </ul>
 * <p>
 * The {@code c:} tags below used to come from NeoForge's {@code Tags} constants, which is the only thing that kept this
 * class -- and through it every AE2 tool and material item -- out of {@code :common}. They are spelled out instead;
 * {@code ConventionTagsTest} pins each one against the NeoForge constant it replaced so the two cannot drift.
 */
public final class ConventionTags {
    ...
    public static final TagKey<DataComponentType<?>> EXPORTED_SETTINGS = net.minecraft.tags.TagKey.create(
            ...
            Identifier.fromNamespaceAndPath(AEConstants.MOD_ID, "exported_settings"));
    ...
    public static final TagKey<Block> SAPLINGS = blockTag("c:saplings");
